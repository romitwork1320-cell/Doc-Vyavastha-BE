...
BEGIN
    ...
    INSERT INTO public.user_activities (
        user_id, user_name, tenant_id, url, method, ip_address, description, changes
    ) VALUES (
        v_user_id, v_user_name, v_tenant_id, v_url, v_method, v_ip, v_description, v_changes
    );
...
ALTER TABLE user_activities DROP COLUMN IF EXISTS branch_id;
